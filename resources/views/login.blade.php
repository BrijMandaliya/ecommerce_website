...
<body style="background-image: url('{{ asset('image1.png') }}'); background-size: cover;">
                                            ...
                                            <form action="/userlogin">
                                                ...
                                                <div class="form-group">
                                                    <input type="email" name="logemail" class="form-style"
                                                        ...
                                                        style="background-color: #064f7f" autocomplete="off">
                                                    <i class="input-icon fa-regular fa-envelope"
                                                        style="margin-top: 12px;color:#9abbd5"></i>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input type="password" name="logpass" class="form-style"
                                                        placeholder="Your Password" id="logpass"
                                                        style="background-color: #064f7f" autocomplete="off">
                                                    <i class="input-icon fa-solid fa-lock"
                                                        style="margin-top: 12px;color:#9abbd5"></i>
                                                </div>
                                                <Button type="submit" class="btn mt-4"
                                                    style="color: white;background-color: #064f7f;">submit</Button>
                                            ...
                                            <form action="/userregister">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="logname" class="form-style"
                                                        ...
                                                        style="background-color: #064f7f" autocomplete="off">
                                                    <i class="input-icon fa-regular fa-user"
                                                        style="margin-top: 12px;color:#9abbd5"></i>

                                                    @error('logname')
                                                        <p class="text-danger">{{ $message == "The logname field format is invalid."? "Name Should Be in String only" : $message }}</p>
                                                    @enderror
                                                </div>
                                                <div class="form-group mt-2">
                                                    <input type="email" name="logemail" class="form-style"
